programa{
	...
	funcao inicio(){
		...
		escreva("45) O exercicio 44 vai ter um problema quando digitarmos o primeiro valor maior que o último. Resolva esse problema com um código que funcione em qualquer situação.\n")
